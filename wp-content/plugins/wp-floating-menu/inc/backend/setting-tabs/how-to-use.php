                        ...
                        <div class="about-desc-wrap clearfix">
                            ...
                            <div class="about-title-content">
                              <div class="wpfm-title"><?php _e( 'Custom Template options', 'wp-floating-menu' ); ?></div>
                                ...
                                <i class="fa fa-star"></i><strong><?php _e( 'Note ', 'wp-floating-menu' ); ?>:</strong><?php _e( 'Setting differs according to menu template layout, so all setting maynot be implementable for all templates.', 'wp-floating-menu' ); ?>
                            </div>
                            <p><?php _e( "If you wish to view complete documentation, please visit:
                                <a target='_blank' href='http://accesspressthemes.com/documentation/wp-floating-menu/'>HERE</a>", "wp-floating-menu" ); ?></p> 
                        </div><!--  .about-content --> 
                    </div><!-- .about-desc-wrap -->         
